    ...
    <div class="col-md-7 col-lg-7 mb-4 mb-md-0">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <span>I distinguish three main text objectives. First, your objective could be merely to inform people. A
        ...
        <div class="col-md-7 col-lg-7 mb-4 mb-md-0">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <span>I distinguish three main text objectives. First, your objective could be merely to inform people.
                        A second be to persuade people.</span>
                </div>
                <div class="card-footer border-top">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item"><i class="bx bx-check"></i> 74 Tasks</li>
